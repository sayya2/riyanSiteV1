...
import { getProjectCategories, getProjectServices, getProjects } from "@/lib/db";
...
export default async function ProjectsPage({
  ...
  const perPage =
    typeof resolvedParams?.perPage === "string" ? Number(resolvedParams.perPage) : 24;
    ...
    <main className="min-h-screen bg-white">
      <div className="container mx-auto px-4 mt-10 py-16 space-y-10">
        <div className="flex flex-col gap-6">
          <div>
            <h1 className="text-4xl md:text-5xl font-semibold text-gray-900">Projects</h1>
            <p className="text-gray-700 mt-2">
              Browse our portfolio across buildings, resorts, infrastructure, planning, and more.
            </p>
          </div>
          <FiltersBar
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {projects.map((project) => {
            const href = project.post_name ? `/projects/${project.post_name}` : "#";
            ...
            return (
              ...
              >
                ...
                <div className="absolute inset-0 flex flex-col justify-end p-5 space-y-2">
                  ...
                  <p className="text-sm text-white/80 leading-relaxed line-clamp-2">{excerpt}</p>
                </div>
              </Link>
            );
          })}
